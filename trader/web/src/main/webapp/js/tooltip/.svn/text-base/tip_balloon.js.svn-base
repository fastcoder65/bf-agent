...
//config. BalloonImgPath = "./images/tooltip" // Path to images (border, corners, stem), in quotes. Path must be relative to your HTML file.
config. BalloonImgPath = ( sImgPath != null ) ? sImgPath +"/tooltip" : "./images/tooltip"
