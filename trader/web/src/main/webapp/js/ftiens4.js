...
function linkFolderHTML(isTextLink)
{
  ...
  {
        if (USEFRAMES)
          docW = docW + "<a href='" + this.hreference + "' TARGET=\"main\" "
        else
...
function leftSideHTML(leftSideCoded) {
        ...
        for (i=0; i<leftSideCoded.length; i++)
        {
                ...
                {
                        retStr = retStr + "<td valign=top background=" + ICONPATH + "ftv2vertline.gif><img src='" + ICONPATH + "ftv2vertline.gif'></td>"
                }
                if (leftSideCoded.charAt(i) == "0")
                {
                        retStr = retStr + "<td valign=top><img src='" + ICONPATH + "ftv2blank.gif'></td>"
                }
        }
        return retStr
}
