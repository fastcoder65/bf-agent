...
public class ProxyTunnelDemo {
    ...
    public final static void main(String[] args) throws Exception {
        ...
        try {
            Writer out = new OutputStreamWriter(socket.getOutputStream(), HTTP.DEFAULT_CONTENT_CHARSET);
            ...
            BufferedReader in = new BufferedReader(
                    new InputStreamReader(socket.getInputStream(), HTTP.DEFAULT_CONTENT_CHARSET));
            String line = null;
